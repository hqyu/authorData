...
# projects = ['国家杰出青年科学基金']
names = ['陈萍','王强','杨越','陈胜利','魏小林','于达仁','樊建人','魏子栋','张承慧','梁振兴','翁羽翔','钟文琪','卢革宇','吴云','朱庆山']
random_agent = USER_AGENTS[randint(0, len(USER_AGENTS) - 1)]



cookie = '__utmz=189275190.1651222836.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); _ga=GA1.3.1449889786.1653025996; PHPSESSID=npej8uksl9ncoht34en6pnp7b3; Hm_lvt_a94e857ae4207c3ac8fcfd63f6604f22=1653097322,1653150719,1653184768,1653298986; __utma=189275190.1449889786.1653025996.1653201306.1653298986.8; __utmc=189275190; _gid=GA1.3.1449480237.1653298986; Hm_lpvt_a94e857ae4207c3ac8fcfd63f6604f22=1653298992'
headers = {
...
for name in names:
    ...
    lefturl = "&age=&name=&person="+urllib.parse.quote(name)+"&no=&company=&addcomment_s1=&addcomment_s2=""&addcomment_s3=&addcomment_s4=&money1=100&money2=&startTime=1997&endTime=2020&province_main=&subcategory=&searchsubmit=true"
    ...
    prefs = {'profile.default_content_settings.popups': 0,  # 防止保存弹窗
             'download.default_directory': 'D:\\authorData\\projectinfo\\xls3\\',  # 设置默认下载路径
